/**
 “Spirograph” is the trademarked name for a toy where you place a pencil inside a circle and spin it around the circumference of another circle, creating various geometric patterns that are known as roulettes
 Ref: https://en.wikipedia.org/wiki/Hypotrochoid)
 */
import SwiftUI
...
struct Spirograph: Shape {
    ...
    // To calculate the greatest common divisor (GCD) of the inner radius and outer radius
