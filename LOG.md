...
**Today's Progress**: CoreData, AppStorage, NSPersistentContainer, @FetchRequest, SortDescriptor, @Environment, @Binding, \\.managedObjectContext.

**Thoughts**: CoreData is a persistence framework to persist objects into the device. Once an entity is defined in the model, a corresponding class is generated by XCode. However, the preview function does not work when a CoreData is used. I can only view the result in a simulator.

**Link to work**: [Bookworm](./Bookworm/)

## Day 23: 6 Jul 2022

**Today's Progress**: Manual CoreData Mode, NSPredicate, NSMergePolicy

**Thoughts**: XCode allows us to manually create CoreData entity classes with relationships. NSPredicate allows us to retrieve entity objects in an object-oriented way.

**Link to work**: [CoreDataProject](./CoreDataProject/)
